...
export function saveAc(){
 ...
 var prior=l[i]||{};var a={id:id.indexOf('NEW_')===0?n:id,n:n,type:el('acType').value,year:prior.year||null,engine:prior.engine||'',propeller:prior.propeller||'',serialApplicability:prior.serialApplicability||'',emptyWt:nv('acEmptyWt')||0,emptyArm:nv('acEmptyArm')||0,maxWt:nv('acMaxWt')||0,fuelPpg:nv('acFuelPpg')||6,frontArm:nv('acFrontArm')||0,rearArm:nv('acRearArm')||0,bagArm:nv('acBagArm')||0,fuelArm:nv('acFuelArm')||0,fuelBurn:nv('acFuelBurn')||9,xwLimit:nv('acXwLimit')||17,tankInterval:parseInt(localStorage.jp_tankInterval||'60'),notes:readNotes()};
